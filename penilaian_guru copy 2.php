              ...
              <select name="kriteria-<?= $key ?>[]" class="form-control form-control-sm"
                ...
                <?php
                          if ($kriteria['kode_kriteria'] == 'C1') {
                            ...
                            $rentang = $data['pendidikan'];
                          } elseif ($kriteria['kode_kriteria'] == 'C3' || $kriteria['kode_kriteria'] == 'C5') {
                            foreach ($queryC3C5 as $c3c5) {
                              if ($c3c5['id_guru'] == $data['id_guru']) {
                                // $ctiga[$key]['id_guru'] = $data['id_guru'];
                                // $ctiga[$key]['nilai'] = (($c3c5['c31'] / 2) + ($c3c5['c32'] / 2)) / $maxNilaiGuru * 100;
                                // $clima[$key]['id_guru'] = $data['id_guru'];
                                // $clima[$key]['nilai'] = (($c3c5['c51'] / 2) + ($c3c5['c52'] / 2)) / $maxNilaiGuru * 100;

                                if ($kriteria['kode_kriteria'] == 'C3') {
                                  // $ctiga[] = $c3c5['c31'] + $c3c5['c32'];
                                  // $ctiga[] = (($c3c5['c31'] / 2) + ($c3c5['c32'] / 2)) / $maxNilaiGuru * 100;
                                  $nilaiC3 = (($c3c5['c31'] / 2) + ($c3c5['c32'] / 2)) / $maxNilaiGuru * 100;
                                  // $nilaiC3 = (($c3c5['c31'] / 2) + ($c3c5['c32'] / 2)) / $maxNilaiGuru * 100;
                                  if ($nilaiC3 >= 81) {
                                    $nilai = 1;
                                    // $rentang = "81-100";
                                  ...
                                  $nilaiC5 = (($c3c5['c51'] / 2) + ($c3c5['c52'] / 2)) / $maxNilaiGuru * 100;
                                  if ($nilaiC5 >= 81) {
                                    $nilai = 1;
                                    // $rentang = "81-100";
                                  } elseif ($nilaiC5 >= 61) {
                ...
                <?php if ($kriteria['kode_kriteria'] != 'C4') : ?>
                <option value="<?= $nilai ?>">
                  <?= $rentang ?>
                </option>
                <?php endif; ?>
