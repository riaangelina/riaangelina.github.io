  ...
  <div class="main-wrapper" style="background-color: rgba(255, 255, 255, 0.4);">
    ...
    <div class="auth-wrapper d-flex no-block justify-content-center align-items-center position-relative">
      <div class="row p-4 justify-content-center">
        <div class="col-lg-6 col-md-7" style="background-color: #7FEDF1;">
          <div class="p-3">
            <h2 class="mt-3 text-center font-weight-medium text-dark">Login</h2>
            <form method="post" action="./control/cek_login.php" class="mt-4">
              <div class="row">
                <div class="col-lg-12">
                ...
                <div class="col-lg-12 mt-3">
                  <h5 class="text-dark">Lupa kata sandi? <a href="./forgot.php">Klik di sini!</a></h5>
                </div>
